...
SET26 = R_TRIG SV64T # OPENED DUE TO LOV FOR AUTO CLOSE - SHORT
RST26 = R_TRIG SV54T # AUTO CLOSED - SHORT
...
SV56 = R_TRIG SV62T OR R_TRIG SV54T # AUTO CLOSE INDICATION WITH TIMER FOR CLOSE INTO FAULT DETECTION
CL3P = (SV13T AND LT05 OR CC3 AND LT03 OR SV62T OR SV54T) AND LT06 AND SV38 # 3-PH CLOSE CONDITIONS
ULCL3P = TRIP3P OR NOT (LT06 AND SV38 OR CLOSE3P) OR NOT (LT05 OR CLOSE3P OR CC3 AND LT03 OR 79CY3P OR SV62T OR SV54T) OR SV22T AND MV17 <> 0.00 # 3-PH CLOSE UNLATCH