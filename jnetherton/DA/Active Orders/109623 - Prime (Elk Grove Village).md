...
```
PLT26S := PLT01 AND PCT06Q AND VB008 AND NOT PLT02 AND PSV06 AND NOT PLT27 # LOCAL SOURCE RTS LATCH
- auto mode
- loc src healthy
- adj src healthy
- NOT pref src
- loc src open
- NOT in the middle of pref RTS
...
---
PLT27S := PLT01 AND PCT06Q AND VB008 AND PLT02 AND PSV06 AND NOT PLT26 # LOCAL SOURCE RTS LATCH
- auto mode
- loc src healthy
- adj src healthy
- pref src
