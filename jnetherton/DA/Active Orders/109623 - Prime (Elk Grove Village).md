...
ASV019 := VB022 AND LB01 OR VB023 AND NOT LB01 # ADJACENT SOURCE WAY TIMING TO CLOSE
ASV020 := VB023 AND LB01 OR VB022 AND NOT LB01 # ADJACENT TIE WAY TIMING TO CLOSE
ASV017 := (((NOT IN302 OR ALT06) AND (NOT VB002 OR ASV019) AND (NOT VB004 OR ASV020)) AND NOT VB030 OR (IN301 OR ALT06) AND VB030) AND NOT ALT02 # BLOCK WAY 1 PARALLELING
ASV018 := (((NOT IN102 OR ALT04) AND (NOT VB002 OR ASV019) AND (NOT VB004 OR ASV020)) AND NOT VB030 OR (IN101 OR ALT04) AND VB030) AND NOT ALT02 # BLOCK WAY 6 PARALLELING


Control power available for comms checks. Current/voltage sensing to be verified post-energization.